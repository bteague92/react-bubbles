...
It is used to allow access to authorized parts of a site.

- [ ] What steps can you take in your web apps to keep your data secure?

Put thinkgs in private routes, only allow access to those with a token, and enable session storag instead of local storage
